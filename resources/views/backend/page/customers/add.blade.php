...
@section('content')
    ...
    <form action="{{ route('adminAddSaveCustomers') }}" method="POST" class="row" enctype="multipart/form-data">
        @csrf
        <div class="col-md-8">
            <div class="card mb-4 border-left-primary">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <input type="email" name="email" class="form-control bg-dark text-light border-0 small col-md-8" required>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 mt-2">Customers Photo</label>
                        <input type="file" name="photo" class="form-control-file bg-dark text-light border-0 small col-md-8" style="padding-top: 7px;" required>
                    </div>
                    <div class="form-group row mb-3">
                        <label class="col-md-3 mt-2">Customers Password</label>
                        <input type="password" name="password" class="form-control bg-dark text-light border-0 small col-md-8" required>
                    </div>
                </div>
            </div>
        </div>
